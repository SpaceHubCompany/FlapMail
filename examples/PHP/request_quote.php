...
<head>
  ...
  <title>Request a Quote - FlapMail PHP Example</title>
...
<body>
  <div class="card">
    ...
    <p>A quote request form for services, products, or projects.</p>
    ...
    <form method="post" >
      ...
      <label for="company">Company</label><input id="company" name="company" required />
      <label for="name">Contact Name</label><input id="name" name="name" required />
      <label for="email">Email</label><input id="email" name="email" type="email" required />
      <label for="phone">Phone</label><input id="phone" name="phone" />
      <label for="service">Service Needed</label><select id="service" name="service" required><option value="">Select one</option><option>Website</option><option>Landing Page</option><option>Automation</option><option>Integration</option></select>
      <label for="budget">Estimated Budget</label><select id="budget" name="budget" required><option value="">Select one</option><option>Under $500</option><option>$500 to $2,000</option><option>$2,000 to $10,000</option><option>Over $10,000</option></select>
      <label for="message">Project Details</label><textarea id="message" name="message" required></textarea>
