...
<body>
  <div class="card">
    <h1>I Need Help</h1>
    <p>A support form with dropdown options for category and priority.</p>
    ...
    <form method="post" >
      ...
      <label for="category">Help Category</label><select id="category" name="category" required><option value="">Select one</option><option>Technical Support</option><option>Sales</option><option>Billing</option><option>Partnership</option></select>
      <label for="priority">Priority</label><select id="priority" name="priority" required><option value="">Select one</option><option>Low</option><option>Medium</option><option>High</option><option>Urgent</option></select>
