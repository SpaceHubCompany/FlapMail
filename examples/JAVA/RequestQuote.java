...
public class RequestQuote {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        payload.put(\"company\", \"Northwind Labs\");
        payload.put(\"service\", \"Website Development\");
        payload.put(\"budget\", \"$1,000 - $5,000\");
        payload.put(\"message\", \"I would like a quote for a responsive website.\");
