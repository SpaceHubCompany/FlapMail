...
payload = {'name': 'Alex Johnson', 'email': 'alex@example.com', 'company': 'Northwind Labs', 'service': 'Website Development', 'budget': '$1,000 - $5,000', 'message': 'I would like a quote for a responsive website.'}
